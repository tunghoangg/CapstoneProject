            ...
            modelBuilder.Entity("RAFS.Core.Models.AspUser", b =>
                {
                    ...
                    b.Property<DateTime>("LastUpdated")
                        ...
                        .HasDefaultValue(new DateTime(2024, 3, 16, 6, 8, 51, 460, DateTimeKind.Utc).AddTicks(1069));
            ...
            modelBuilder.Entity("RAFS.Core.Models.Blog", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 16, 6, 8, 51, 460, DateTimeKind.Utc).AddTicks(1910));

                    b.Property<DateTime>("LastUpdated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 16, 6, 8, 51, 460, DateTimeKind.Utc).AddTicks(2208));
            ...
            modelBuilder.Entity("RAFS.Core.Models.CashFlow", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 16, 6, 8, 51, 460, DateTimeKind.Utc).AddTicks(4465));
            ...
            modelBuilder.Entity("RAFS.Core.Models.Diary", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDay")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 16, 6, 8, 51, 460, DateTimeKind.Utc).AddTicks(6011));
                    ...
                    b.Property<DateTime>("LastUpdate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 16, 6, 8, 51, 460, DateTimeKind.Utc).AddTicks(6371));
            ...
            modelBuilder.Entity("RAFS.Core.Models.Employee", b =>
                {
                    ...
                    b.Property<DateTime>("LastUpdated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 16, 6, 8, 51, 460, DateTimeKind.Utc).AddTicks(7292));
            ...
            modelBuilder.Entity("RAFS.Core.Models.Farm", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 16, 6, 8, 51, 460, DateTimeKind.Utc).AddTicks(8816));
                    ...
                    b.Property<DateTime>("EstablishedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 16, 6, 8, 51, 460, DateTimeKind.Utc).AddTicks(8584));

                    b.Property<DateTime>("LastUpdate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 16, 6, 8, 51, 460, DateTimeKind.Utc).AddTicks(9131));
            ...
            modelBuilder.Entity("RAFS.Core.Models.Item", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 16, 6, 8, 51, 461, DateTimeKind.Utc).AddTicks(411));
                    ...
                    b.Property<DateTime>("LastUpdate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 16, 6, 8, 51, 461, DateTimeKind.Utc).AddTicks(800));
            ...
            modelBuilder.Entity("RAFS.Core.Models.Milestone", b =>
                {
                    ...
                    b.Property<DateTime>("LastUpdate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 16, 6, 8, 51, 461, DateTimeKind.Utc).AddTicks(2235));
            ...
            modelBuilder.Entity("RAFS.Core.Models.Plant", b =>
                {
                    ...
                    b.Property<DateTime>("LastUpdate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 16, 6, 8, 51, 461, DateTimeKind.Utc).AddTicks(3553));
            ...
            modelBuilder.Entity("RAFS.Core.Models.QuestionForm", b =>
                {
                    ...
                    b.Property<DateTime>("SendDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 16, 6, 8, 51, 461, DateTimeKind.Utc).AddTicks(4576));
            ...
            modelBuilder.Entity("RAFS.Core.Models.TakeAndSendMaterial", b =>
                {
                    ...
                    b.Property<DateTime>("LastUpdate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 16, 6, 8, 51, 461, DateTimeKind.Utc).AddTicks(5365));
            ...
            modelBuilder.Entity("RAFS.Core.Models.UserFunctionFarm", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 16, 6, 8, 51, 461, DateTimeKind.Utc).AddTicks(7215));
